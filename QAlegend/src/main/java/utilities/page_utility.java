...
public class page_utility {
	...
	public static void naviateToNextPage(WebDriver driver) {
	...
	public static void selectDropdownbyIndex(WebElement b, int index) {
		Select select = new Select(b);
...
public static void ControlkeyPress(WebDriver driver,WebElement element){
	Actions actions=new Actions(driver);
...
public static void escpKeyPress(WebDriver driver) {
	Actions actions=new Actions(driver);
